  ...
  FutureOr<void> _onCreate(Database db, int version) async {
    ...
    await db.transaction((txn) async {
      ...
      await txn.insert('user', {
        ...
        'contact': '0770000001',
        'password': _hashPassword('password1'), // Properly hashed password
        'role': 'Cashier',
        'color_code': '#000000',
        'created_at': now,
        'updated_at': now,
      ...
      await txn.insert('user', {
        ...
        'contact': '0770000002',
        'password': _hashPassword('password2'), // Properly hashed password
        'role': 'Manager',
        'color_code': '#000000',
        'created_at': now,
        'updated_at': now,
      ...
      await txn.insert('user', {
        ...
        'email': 'stock@demo.lk',
        'contact': '0770000003',
        'password': _hashPassword('stock123'), // Properly hashed password
        'role': 'StockKeeper',
        'color_code': '#FF0000',
        'created_at': now,
        'updated_at': now,
